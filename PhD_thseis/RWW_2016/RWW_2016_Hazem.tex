...
\documentclass[english,10pt,conference,letterpaper]{RWWTemplate}
\usepackage[T1]{fontenc}
\usepackage{geometry}
\geometry{verbose,tmargin=2.2cm,bmargin=2.2cm,lmargin=1.8cm,rmargin=1.8cm}
\usepackage{amsmath}
\usepackage{amssymb}
\usepackage{graphicx}
...
\begin{figure}
\includegraphics[width=1\columnwidth,height=0.13\paperheight]{collision_distribution}
...
case. 
\begin{figure}
\includegraphics[width=1\columnwidth,height=0.15\paperheight]{Max_eff_validation_0\lyxdot 1_0\lyxdot 5_0\lyxdot 9}
...
\begin{figure}
\includegraphics[width=1\columnwidth,height=0.15\paperheight]{saving_time_new}\protect\caption{Mean reading time reduction using the proposed frame length compared
